import can
import sys
from python_uds import DiagnosticSessionControl, ReadDataByIdentifier
...
class UDSDiscovery(CANCommunication):
    ...
    def uds_discovery(self):
        ...
        diagnostic_session_request = DiagnosticSessionControl(0x01)  # 0x01 for default session
        ...
        read_data_request = ReadDataByIdentifier(0xF190)  # Example identifier for vehicle info
